...
<head>
    ...
    <title>GreenPark - Voir les details du vehicule</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="view-vehicle.php">Voir le véhicule</a></li>
                                    <li class="active">Voir les détails du véhicule</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Voir les détails du véhicule</strong>
                        </div>
                        <div class="card-body">
                                ...
                                <th>Plaque</th>
                                   ...
                                   <tr>
                                    <th>Nom du propriétaire</th>
                                      ...
                                      <tr>  
                                       <th>Téléphone du proprietaire</th>
