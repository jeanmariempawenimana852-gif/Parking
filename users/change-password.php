...
$query1=mysqli_query($con,"select ID from utilisateurs where ID='$userid' and   motdepasse='$cpassword'");
$row=mysqli_fetch_array($query1);
if($row>0){
$ret=mysqli_query($con,"update utilisateurs set motdepasse='$newpassword' where ID='$userid'");

echo '<script>alert("Votre mot de passe a été modifié avec succès.")</script>';
} else {
echo '<script>alert("Votre mot de passe actuel est incorect.")</script>';
...
<head>
    ...
    <title>Greenpark - Changer le mot de passe</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Changer </strong> le mot de passe
                            </div>
                            <div class="card-body card-block">
                                <form action="" method="post" class="form-horizontal" name="changepassword" onsubmit="return checkpass();">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mot de passe actuel</label></div>
                                        <div class="col-12 col-md-9"><input type="password" name="currentpassword" class=" form-control" required= "true" value=""></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Nouveau mot de passe</label></div>
                                        <div class="col-12 col-md-9"><input type="password" name="newpassword" class="form-control" value="" required="true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Confirmer le mot de passe</label></div>
