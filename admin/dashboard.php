...
<head>
   ...
   @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap');
    ...
    /*.content{
        ...
        .warning{
            background-color: rgb(78, 94, 146);
             color:red;
        }
                    ...
                    <tbody>
                        <?php if ($recentVehicles && mysqli_num_rows($recentVehicles) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $vehicle['frais'] ? $vehicle['frais'] . ' Fbu' : '-'; ?></td>
                                <td>
                                    <?php if ($vehicle['Status'] == 'Out'): ?>
                                        <span class="status status-Out warning">Sorti</span>
                                    <?php else: ?>
